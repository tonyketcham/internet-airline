 ...
 <!-- Help + FAQ
    ...
    <section id='about' class="s-about">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead subhead--dark">Internet Airline is:</h3>
                <h1 class="display-1 display-1--light">Unmatched service,<br>on a global scale.</h1>
            </div>
...
<section class="s-services">
    ...
    <div class="row section-header has-bottom-sep" style="margin-top: -60px;">
            <div class="col-full">
                <h1 class="display-2">Need Help? We've got your back.</h1>
                <a href="rules.php" class="btn btn--primary larger">
                            View System Rules
                        </a>
                <a href="index.php#contact" class="btn btn--primary larger">
                            Contact Us
                        </a>        
            </div>
        </div> <!-- end section-header -->
