...
<body id="top">
  ...
  <body class="text-center">
    <div class="space">
    <form class="form-signin sign-in" id="telement" action="signup.inc.php" method="POST">
      <a href="index.php">
...
<!--
      <h1 class="h3 mb-3 font-weight-normal">Please sign up</h1>
          <input type="search" id="name" class="form-control" name="name" placeholder="Full name" required autofocus>
          <input type="email" id="inputEmail" name="email" class="form-control" placeholder="Email address" required autofocus>
          <input type="password" id="inputPassword" name="password" class="form-control" placeholder="Password" required>
          <input type="password" id="confirmPassword" name="confirmPassword" class="form-control" placeholder="Confirm Password" required>
      
      <button class="btn-block" type="submit" name="submit">Sign up</button>
-->
      ...
      <form class="buttonSpace" action="sign-in.php">
