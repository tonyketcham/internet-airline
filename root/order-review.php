            ...
            <div class="row home-content__main" style="
                ...
                padding: 50px;">
                     ...
                     <div class="fillerbox" style="margin-left: 50px; padding-top: 50px;">
...

                        {
                         ...
                         while ($rows2 = $resultSet2->fetch_assoc()) {
                            ...
                            echo "<div class='tuple-wrapper' style='width:100%; float: right; position: absolute; height: auto; margin-top: -100px; margin-bottom: auto;'><div name='$fid' class='flightTuple' style='background-color: transparent;  width:100%; margin-top: -10px; margin-bottom: -30px;'>
                            <h4>Placed by: $cname <br> Email: $email <br> Mailing Address: $address <br><br> Sets of tickets: $quantity<br> Total to be charged: $$total</h4>
                            </div></div>";
                         }
                          ?>
                     </div>
                    ...
                    <div class="home-content__buttons floatright">
                        <button id="submit" name="submit" class="btn btn--primary larger material--shadow" style="border-radius: 0.2em; border-color: transparent; margin-top: 550px;">
                            Confirm
                        </button>
                    </div>
                  </form>
...
<script type="text/javascript">
 ...
 if(sh.includes(full)){
    alert("You've chosen more tickets than seats on at least one of the flights you've selected.");
}
